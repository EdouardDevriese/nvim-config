...
vim.keymap.set('n', '<C-l>', function() require('harpoon.ui').nav_next() end, {desc = 'Harpoon Nav Next'})
vim.keymap.set('n', '<C-y>', function() require('harpoon.ui').nav_prev() end, {desc = 'Harpoon Nav Prev'})
