...
-- vim.keymap.set('n', '<???>', function() require('harpoon.ui').nav_file(1) end, {desc = 'Harpoon Nav 1'})
-- vim.keymap.set('n', '<???>', function() require('harpoon.ui').nav_file(2) end, {desc = 'Harpoon Nav 2'})
-- vim.keymap.set('n', '<???>', function() require('harpoon.ui').nav_file(3) end, {desc = 'Harpoon Nav 3'})
-- vim.keymap.set('n', '<???>', function() require('harpoon.ui').nav_file(4) end, {desc = 'Harpoon Nav 4'})
